...
battleMembers.dragon.damage = damageDragon;
...
battleMembers.warrior.damage = damageWarrior;
...
const gameActions = {
  knightShift: (action) => {
    battleMembers.dragon.healthPoints -= parseFloat(action());
  },
  mageShift: (action) => {
    battleMembers.dragon.healthPoints -= parseFloat(action());
    battleMembers.mage.mana();
  },
  dragonShift: (action) => {
    battleMembers.mage.healthPoints -= parseFloat(action());
    battleMembers.warrior.healthPoints -= parseFloat(action());
  },
  getBattleMembers: () => console.log(battleMembers),
};
